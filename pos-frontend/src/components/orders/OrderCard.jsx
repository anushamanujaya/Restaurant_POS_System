...
const OrderCard = () => {
  return (
    <div className='w-[470px] bg-[#262626] p-4 rounded-lg mb-4'>
       <div className='flex items-center gap-5 mb-2'>
       <button className='bg-[#f6b100] p-3 text-xl font-bold rounded-lg'>MB
        </button>
        <div className='flex items-center justify-between w-[100%]'>
            <div className='flex flex-col items-start gap-1'>
                <h1 className='text-[#f5f5f5] text-lg font-semibold tracking-wide'>Manujaya Bandara</h1>
        ...
        <div className='flex items-center justify-between mt-4 text-[#ababab]'>
            <p>April 28,2025 08:32 PM</p>
            <p>8 Items</p>
        </div>
        <hr className='w-full mt-4 border-t-1 border-gray-500'/>
        <div className='flex items-center justify-between mt-4'>
             <h1 className='text-[#f5f5f5] text-lg font-semibold'>Total</h1>
             <p className='text-[#f5f5f5] text-lg font-semibold'>Rs. 320.00</p>
        </div>
    </div>
  )
}
